...
bot = setInterval(() => {
	...
	function onCap(res: string, f: (c: number) => void, test = (() => true)) {
	...
	function onCapCraft(res: string, toRes: string, cost: number, f = (() => true)) {
